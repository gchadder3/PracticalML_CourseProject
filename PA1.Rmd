...
With this in mind, a random forest approach was tried so that random 
multiple decision trees could be implemented and the classification results 
taken by majority vote on the classification of the individual trees: 
...
The final model was trained with `mtry` = 2, and the results were perfect 
